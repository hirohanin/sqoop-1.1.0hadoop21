...
public final class JdbcWritableBridge {
  ...
  public static java.lang.Object readObject(int colNum, ResultSet r)
  throws SQLException {
	  java.lang.Object val = r.getObject(colNum);
	  if (r.wasNull()) {
		  return null;
	  } else {
		  return val;
  ...
  public static void writeObject(Object val, int paramIdx, int sqlType,
	      PreparedStatement s) throws SQLException {
	    if (null == val) {
	      s.setNull(paramIdx, sqlType);
	    } else {
	      s.setObject(paramIdx, val);
	    }
	  }
  ...
  public static void writeString(Object val, int paramIdx, int sqlType,
	      PreparedStatement s) throws SQLException {
	    if (null == val) {
	      s.setNull(paramIdx, sqlType);
	    } else {
